...
gem "elasticsearch-transport", "7.17.10"
gem "epub-parser", "~> 0.4"
gem "benchmark", "~> 0.4"
gem "ostruct", "~> 0.6"
...
gem "friendly_id", "~> 5.5"
gem "googleauth", "~> 1.11", ">= 1.11.1"
gem "google-apis-androidpublisher_v3", "~> 0.69", ">= 0.69.0"
